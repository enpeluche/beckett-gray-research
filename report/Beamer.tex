...
\titlegraphic{\includegraphics[width=0.2\textwidth]{Gray.jpg}\hspace{2cm}\includegraphics[width=0.2\textwidth]{Beckett.jpg}}
...
\begin{table}
    \includegraphics[width=0.1\textwidth]{n=3.png}
...
\begin{frame}
    \frametitle{Graphe de retournement et hypercube}
        \begin{table}
            \includegraphics[width=1\textwidth]{hypercubes.png}
...
\begin{table}
    ...
    \includegraphics[width=0.06\textwidth]{n=5 red.png}
...
\begin{table}
    ...
    \begin{tabular}{cc}
        \includegraphics[width=0.1\textwidth]{n=4 bon.png}
        \hspace{2cm}
        \includegraphics[width=0.1\textwidth]{n=4 pas bon.png}\\
    \end{tabular}
...
\begin{frame}
    ...
    \includegraphics[width=0.5\textwidth]{gdrggeg.png}
...
Il y a deux sommets pendant : pas possible
    ...
    \includegraphics[width=0.5\textwidth]{BG_7_exemple.png}
...
\end{definition}
    ...
    \includegraphics[width=0.6\textwidth]{GHam.png}
...
\begin{table}
\includegraphics[scale=0.25]{NbAppel.png}
...
\begin{frame}
    ...
    \begin{tabular}{cc}
        \includegraphics[width=0.4\textwidth]{BG7.png}
        \includegraphics[width=0.4\textwidth]{n=8.png}\\
    \end{tabular}
...
\begin{frame}
    ...
    \begin{tabular}{cc}
        \includegraphics[width=0.5\textwidth]{Temps n=7.png}
        \includegraphics[width=0.5\textwidth]{Temps n=8.png}\\
    \end{tabular}
...
\begin{frame}
    ...
    \begin{table}
        \includegraphics[width=0.65\textwidth]{wouah.png}
